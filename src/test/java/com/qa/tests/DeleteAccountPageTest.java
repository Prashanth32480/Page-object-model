...
public class DeleteAccountPageTest extends TestBase {
	...
	public DeleteAccountPageTest() throws IOException {
		super();
	...
	@Test
	public void verifydeleteaccountTest() {
	...
	public void verifyLogoTest() {
		...
		deleteAccountPage.deleteaccountlogo();
	}
	...
	public void verifyLoginTest() throws IOException {
		...
		deleteAccountPage.deleteAccount(prop.getProperty("DeleteAccountNo"));
